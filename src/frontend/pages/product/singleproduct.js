...
import { Notify, Loader } from "frontend/components";
import { useAuth, useCart, useFilter, useWishlist } from "frontend/context";
      ...
      {findItem && (
        <div className="singleproduct">
          ...
          <div className="singleproduct__info">
            ...
            <h3>
              <i className="fa-solid fa-hand-holding-heart"></i> Handle with
              care
            </h3>
            <h3>
            ...
            <h3>
              <i className="fa-solid fa-arrow-rotate-left"></i> 30 Days return
            </h3>
